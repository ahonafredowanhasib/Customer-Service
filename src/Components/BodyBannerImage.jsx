...
const BodyBannerImage = () => {
    return (
        <div className=' flex gap-[100px] max-w-[1320px] mx-auto'>

            <div className='bg-gradient-to-br from-[#632EE3] to-[#9F62F2] flex justify-center items-center relative rounded-xl h-[250px] w-[700px] overflow-hidden'>
            ...
            <div className='bg-gradient-to-r from-[#54CF6B] to-[#00827A] flex justify-center items-center relative rounded-xl h-[250px] w-[700px] overflow-hidden'>
